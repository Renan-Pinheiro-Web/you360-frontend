...
//  Substitui completamente o supabaseClient.js
//  Uso: import { api } from '../lib/apiClient'
// ============================================================

const BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'http://localhost/api'

// ── Armazena token JWT no sessionStorage (browser only) ───────
const getToken = () => {
  if (typeof window === 'undefined') return null
  return sessionStorage.getItem('you360_token') || null
}

export const setToken = (token) => {
  if (typeof window !== 'undefined') sessionStorage.setItem('you360_token', token)
}

export const removeToken = () => {
  if (typeof window !== 'undefined') sessionStorage.removeItem('you360_token')
}
